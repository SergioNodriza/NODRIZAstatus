...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Controller/Listener/Subscribers/IncidentNotifier.php';
            include_once \dirname(__DIR__, 4).'/src/Controller/Listener/Subscribers/ServiceNotifier.php';
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \App\Controller\Listener\Subscribers\IncidentNotifier($d));
        $c->addEventSubscriber(new \App\Controller\Listener\Subscribers\ServiceNotifier($d));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->privates['App\\Controller\\Listener\\JWTCreatedListener'] ?? ($this->privates['App\\Controller\\Listener\\JWTCreatedListener'] = new \App\Controller\Listener\JWTCreatedListener()));
        }, 1 => 'onJWTCreated'], 0);
