 ...
 */
class getSecurity_Firewall_Map_Context_GetProductsIdService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 0), NULL, NULL, ($container->privates['security.firewall.map.config.getProductsId'] ?? $container->load('getSecurity_Firewall_Map_Config_GetProductsIdService')));
    }
}
