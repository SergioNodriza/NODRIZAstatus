...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Action\\Incident\\CreateIncident' => 'getCreateIncidentService',
            'App\\Controller\\Action\\Product\\CreateProduct' => 'getCreateProductService',
            'App\\Controller\\Action\\Product\\GeneralState' => 'getGeneralStateService',
            'App\\Controller\\Action\\Product\\NameProduct' => 'getNameProductService',
            'App\\Controller\\Action\\Pruebas' => 'getPruebasService',
            'App\\Controller\\Action\\Service\\CreateService' => 'getCreateServiceService',
            'App\\Controller\\Action\\User\\CreateUser' => 'getCreateUserService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Controller/Listener/EntitySubscribers/IncidentNotifier.php';
            include_once \dirname(__DIR__, 4).'/src/Controller/Listener/EntitySubscribers/ServiceNotifier.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/event-dispatcher/EventSubscriberInterface.php';
            include_once \dirname(__DIR__, 4).'/src/Controller/Listener/JWTSubscriber.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\Controller\\Listener\\JsonExceptionResponseTransformerListener'] ?? ($this->privates['App\\Controller\\Listener\\JsonExceptionResponseTransformerListener'] = new \App\Controller\Listener\JsonExceptionResponseTransformerListener()));
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->privates['App\\Controller\\Listener\\JWTSubscriber'] ?? $this->getJWTSubscriberService());
        }, 1 => 'onJWTCreated'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_authenticated', [0 => function () {
            return ($this->privates['App\\Controller\\Listener\\JWTSubscriber'] ?? $this->getJWTSubscriberService());
        }, 1 => 'onAuthenticatedAccess'], 0);
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['App\\Controller\\Listener\\JWTSubscriber'] ?? $this->getJWTSubscriberService());
        }, 1 => 'onAuthenticatedResponse'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader($this->getEnv('resolve:JWT_SECRET_KEY'), $this->getEnv('resolve:JWT_PUBLIC_KEY'), $this->getEnv('resolve:JWT_PASSPHRASE'));
    }
    ...
    /**
     * Gets the private 'App\Controller\Listener\EntitySubscribers\IncidentNotifier' shared autowired service.
     *
     * @return \App\Controller\Listener\EntitySubscribers\IncidentNotifier
     */
    protected function getIncidentNotifierService()
    {
        return $this->privates['App\\Controller\\Listener\\EntitySubscribers\\IncidentNotifier'] = new \App\Controller\Listener\EntitySubscribers\IncidentNotifier(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Controller\Listener\EntitySubscribers\ServiceNotifier' shared autowired service.
     *
     * @return \App\Controller\Listener\EntitySubscribers\ServiceNotifier
     */
    protected function getServiceNotifierService()
    {
        return $this->privates['App\\Controller\\Listener\\EntitySubscribers\\ServiceNotifier'] = new \App\Controller\Listener\EntitySubscribers\ServiceNotifier(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Controller\Listener\JWTSubscriber' shared autowired service.
     *
     * @return \App\Controller\Listener\JWTSubscriber
     */
    protected function getJWTSubscriberService()
    {
        return $this->privates['App\\Controller\\Listener\\JWTSubscriber'] = new \App\Controller\Listener\JWTSubscriber(($this->services['lexik_jwt_authentication.jwt_manager'] ?? $this->getLexikJwtAuthentication_JwtManagerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I7BAUSliLE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pd9GqXGVlI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dOfgZlBovX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ShjGaxgAX+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D9Vluv76n-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.extractor.yaml'] = new \ApiPlatform\Core\Metadata\Extractor\YamlExtractor([0 => (\dirname(__DIR__, 4).'/config/api_platform/resources/Incident.yaml'), 1 => (\dirname(__DIR__, 4).'/config/api_platform/resources/User.yaml'), 2 => (\dirname(__DIR__, 4).'/config/api_platform/resources/Product.yaml'), 3 => (\dirname(__DIR__, 4).'/config/api_platform/resources/Service.yaml')], $this);
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.metadata_factory.validator'] = new \ApiPlatform\Core\Bridge\Symfony\Validator\Metadata\Property\ValidatorPropertyMetadataFactory(($this->services['.container.private.validator'] ?? $this->get_Container_Private_ValidatorService()), ($this->privates['api_platform.metadata.property.metadata_factory.yaml'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_YamlService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.metadata_factory.yaml'] = new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyMetadataFactory(($this->privates['api_platform.metadata.extractor.yaml'] ?? $this->getApiPlatform_Metadata_Extractor_YamlService()), ($this->privates['api_platform.metadata.property.metadata_factory.annotation'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_AnnotationService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.name_collection_factory.yaml'] = new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($this->privates['api_platform.metadata.extractor.yaml'] ?? $this->getApiPlatform_Metadata_Extractor_YamlService()), ($this->privates['api_platform.metadata.property.name_collection_factory.xml'] ?? $this->getApiPlatform_Metadata_Property_NameCollectionFactory_XmlService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.resource.metadata_factory.yaml'] = new \ApiPlatform\Core\Metadata\Resource\Factory\ExtractorResourceMetadataFactory(($this->privates['api_platform.metadata.extractor.yaml'] ?? $this->getApiPlatform_Metadata_Extractor_YamlService()), ($this->privates['api_platform.metadata.resource.metadata_factory.annotation'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_AnnotationService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.resource.name_collection_factory.yaml'] = new \ApiPlatform\Core\Metadata\Resource\Factory\ExtractorResourceNameCollectionFactory(($this->privates['api_platform.metadata.extractor.yaml'] ?? $this->getApiPlatform_Metadata_Extractor_YamlService()), ($this->privates['api_platform.metadata.resource.name_collection_factory.annotation'] ?? $this->getApiPlatform_Metadata_Resource_NameCollectionFactory_AnnotationService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v0odvTe-jU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('s6GgFWibnJ', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v5Kdcb-tb+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3dwfrR4YfS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vWiP5tf83m', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8oRWXqsVYc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MYW3FUl6Hz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_Access_DecisionManager_InnerService()
    {
        return $this->privates['debug.security.access.decision_manager.inner'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\Voter\\IncidentVoter'] ?? $this->load('getIncidentVoter2Service'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\Voter\\ProductVoter'] ?? $this->load('getProductVoter2Service'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\Voter\\ServiceVoter'] ?? $this->load('getServiceVoter2Service'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\Voter\\UserVoter'] ?? $this->load('getUserVoter2Service'));
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['App\\Controller\\Listener\\EntitySubscribers\\IncidentNotifier'] ?? $this->getIncidentNotifierService()));
        $instance->addEventSubscriber(($this->privates['App\\Controller\\Listener\\EntitySubscribers\\ServiceNotifier'] ?? $this->getServiceNotifierService()));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.getProducts' => ($this->privates['.security.request_matcher.E4OVAw1'] ?? ($this->privates['.security.request_matcher.E4OVAw1'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products$', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getProductsId' => ($this->privates['.security.request_matcher.kO8yXm4'] ?? ($this->privates['.security.request_matcher.kO8yXm4'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products/.*', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getProductsGeneral' => ($this->privates['.security.request_matcher.vzxQBRX'] ?? ($this->privates['.security.request_matcher.vzxQBRX'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products/general', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getProductsNames' => ($this->privates['.security.request_matcher.Nf6IVfR'] ?? ($this->privates['.security.request_matcher.Nf6IVfR'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products/names', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getServices' => ($this->privates['.security.request_matcher.fs_HQNv'] ?? ($this->privates['.security.request_matcher.fs_HQNv'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/services$', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getServicesId' => ($this->privates['.security.request_matcher.Uz9p7Jt'] ?? ($this->privates['.security.request_matcher.Uz9p7Jt'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/services/.*', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getIncidents' => ($this->privates['.security.request_matcher.aE_Ak04'] ?? ($this->privates['.security.request_matcher.aE_Ak04'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/incidents$', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getIncidentsId' => ($this->privates['.security.request_matcher.XedioR8'] ?? ($this->privates['.security.request_matcher.XedioR8'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/incidents/.*', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getProductsIdServices' => ($this->privates['.security.request_matcher.bvAEjVw'] ?? ($this->privates['.security.request_matcher.bvAEjVw'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products/.*/services', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.getIncidentsIdServices' => ($this->privates['.security.request_matcher.3HTf0UU'] ?? ($this->privates['.security.request_matcher.3HTf0UU'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/incidents/.*/services', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.register' => ($this->privates['.security.request_matcher..9eelJG'] ?? ($this->privates['.security.request_matcher..9eelJG'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/incidents/create', NULL, [0 => 'POST'])));
            yield 'security.firewall.map.context.login' => ($this->privates['.security.request_matcher.rZ3JWF5'] ?? ($this->privates['.security.request_matcher.rZ3JWF5'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/login')));
    ...
    {
        return $this->privates['serializer.mapping.chain_loader'] = new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain([0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService())), 1 => new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/config/api_platform/serialization/Incident.yaml')), 2 => new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/config/api_platform/serialization/Product.yaml')), 3 => new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/config/api_platform/serialization/Service.yaml')), 4 => new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/config/api_platform/serialization/User.yaml'))]);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'lexik_jwt_authentication.pass_phrase': $value = $this->getEnv('resolve:JWT_PASSPHRASE'); break;
            case 'lexik_jwt_authentication.token_ttl': $value = $this->getEnv('resolve:JWT_TOKEN_TTL'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'NODRIZAstatus API Platform',
            'api_platform.description' => '',
            'api_platform.version' => 1.0,
            ...
            'security.firewalls' => [
                0 => 'getProducts',
                1 => 'getProductsId',
                2 => 'getProductsGeneral',
                3 => 'getProductsNames',
                4 => 'getServices',
                5 => 'getServicesId',
                6 => 'getIncidents',
                7 => 'getIncidentsId',
                8 => 'getProductsIdServices',
                9 => 'getIncidentsIdServices',
                10 => 'register',
                11 => 'login',
                12 => 'api',
            ],
